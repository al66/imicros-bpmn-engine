...
const instance = require("../machines/instance");
...
class Application {
    ...
    async loadInstance({ instanceId, version = 0, snapshot = {}, events = [], timeuuid = null }) {
        await this.restore({ version, snapshot, events, timeuuid });
        this.uid = instanceId;
